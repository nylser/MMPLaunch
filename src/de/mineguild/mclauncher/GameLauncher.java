...
import de.mineguild.utils.BasicArgsParser;
import de.mineguild.utils.UIUtil;
import de.mineguild.utils.Util;
...
import static de.mineguild.utils.BasicArgsParser.ArgsContext;
...
public class GameLauncher {
    ...
    private GameLauncher(File baseDir, String activeJar) {
        ...
        this.actualDir = baseDir; //TODO: Add implementation
    ...
    private void setupEnvironment() throws LaunchException {
        ...
        System.setProperty("minecraft.applet.WrapperClass", "de.mineguild.mclauncher.launch.GameAppletContainer");
